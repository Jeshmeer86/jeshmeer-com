        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div>
            ...
            <div className="mt-2 text-sm text-muted">
              Bespoke software. Governance by design. Evidence grade audit trails.
            </div>
          ...
          <div>
            ...
            <div className="mt-3 grid gap-2 text-sm text-muted">
              ...
              <Link href="/ai-automation" className="hover:text-text">AI and Automation</Link>
              <Link href="/industries/luxury-automotive" className="hover:text-text">Luxury Automotive</Link>
              <Link href="/industries/luxury-property" className="hover:text-text">Luxury Property</Link>
              <Link href="/industries/hospitals-medical-centers" className="hover:text-text">Hospitals and Medical Centers</Link>
            </div>
          </div>

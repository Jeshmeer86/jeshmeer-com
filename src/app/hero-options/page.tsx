...
const options = [
  { key: "loop", label: "Cinematic loop (animated)", src: "/hero/hero-loop.webp" },
      ...
      <div className="py-10">
        <div className="glass borderGlow rounded-2xl p-8">
          ...
          <p className="mt-3 max-w-3xl text-sm text-muted">
            Pick the option you want and tell me the key: loop, car, skyline, or abstract.
          </p>
        </div>
      </div>

      <Section title="Options" subtitle="These are included in your project and can be swapped in seconds.">
        <div className="grid gap-4 md:grid-cols-3">
          {options.map((o) => (
            <div key={o.key} className="glass borderGlow rounded-2xl overflow-hidden">
              <div className="relative">
                <img src={o.src} className="h-48 w-full object-cover" alt={o.label} />

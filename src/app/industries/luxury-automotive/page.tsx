...
<div className="py-10">
  <div className="relative glass borderGlow rounded-2xl overflow-hidden p-8">
    <img src="/sections/auto.jpg" alt="Luxury Automotive Solutions" className="absolute inset-0 h-full w-full object-cover opacity-85" />
    ...
    <div className="relative">
      ...
      <h1 className="mt-3 text-3xl font-semibold tracking-tight">Luxury Automotive Solutions</h1>
    </div>
  </div>
</div>

      <Section title="Luxury Automotive Solutions" subtitle="High value vehicle transactions need proof, control, and speed. We build AI and automation driven workflows that protect brand reputation and reduce dispute exposure.">
        <div className="grid gap-4 md:grid-cols-2">
          <div className="glass borderGlow rounded-2xl p-6">
            ...
            <ul className="mt-3 list-disc space-y-1 pl-5 text-sm text-muted">
              ...
              <li>Admin approvals and exception handling for high risk cases</li>
          ...
          <div className="glass borderGlow rounded-2xl p-6">
            ...
            <ul className="mt-3 list-disc space-y-1 pl-5 text-sm text-muted">
              ...
              <li>Automation for notifications, status updates, and internal routing</li>
            </ul>
          </div>
        </div>
      </Section>
